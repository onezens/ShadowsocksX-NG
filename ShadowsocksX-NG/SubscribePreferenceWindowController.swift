...
class SubscribePreferenceWindowController: NSWindowController
    ...
    let tableViewDragType = NSPasteboard.PasteboardType.init("subscribe.host")
    ...
    override func awakeFromNib() {
        SubscribeTableView.registerForDraggedTypes([tableViewDragType])
    ...
    func tableView(_ tableView: NSTableView, pasteboardWriterForRow row: Int) -> NSPasteboardWriting? {
        ...
        item.setString(String(row), forType: tableViewDragType.self)
        return item
    }
